  ...
  <div class="flex flex-col min-h-screen bg-white text-gray-900">
    ...
    <header class="bg-gray-900 text-white shadow sticky top-0 z-50">
      <nav class="max-w-4xl mx-auto px-6 py-4 flex justify-between items-center">
        <router-link to="/" class="text-base md:text-xl font-bold hover:text-gray-300 transition font-mono tracking-tight whitespace-nowrap">&lt; imurar /&gt;</router-link>
        <ul class="flex gap-6 md:gap-8 text-sm md:text-base">
